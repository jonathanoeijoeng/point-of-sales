...
<template>
    <svg
        class="text-red-600 fill-current cursor-pointer hover:scale-125"
    ...
    >
        ...
        />
        <path
            d="m342.248 289.395-32.963 32.963-32.962-32.963-21.213 21.213 32.963 32.963-32.963 32.962 21.213 21.213 32.962-32.963 32.963 32.963 21.213-21.213-32.963-32.962 32.963-32.963z"
        />
    </svg>
</template>
